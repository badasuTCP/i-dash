      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        {revenueData && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <ScoreCard label="Active I-BOS Contractors Revenue" value={revenueData.active_total || 0} change={revenueData.active_pct} color="blue" format="currency" sparkData={[]} />
            <ScoreCard label="In-Active I-BOS Contractors Revenue" value={revenueData.inactive_total || 0} change={0} color="amber" format="currency" sparkData={[]} />
