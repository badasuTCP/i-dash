...
// ── Static seed data (used as fallback when no pipeline has run) ──────────
...
const SEED_FALLBACK = {
  ...
  performanceSummary: SEED_PERFORMANCE,
  spendByPeriod: SEED_SPEND_BY_PERIOD,
};

const SaniTredMarketing = () => {
  const mkt = useMarketingData('sanitred', SEED_FALLBACK);
